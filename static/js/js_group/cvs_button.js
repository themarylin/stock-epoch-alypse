...
function cvs_url() {
    ...
    d3.json("api/rand?stock=CVS").then(function (rand_response) {
        var jump1 = 50;
    ...
    d3.json("api/scen?stock=CVS").then(function (response) {
        var jump = 50;
        ...
        renderLineChart(dates, ideal, 'ideal-chart', 'Ideal (CVS)');
        renderLineChart(dates, ml, 'ml-chart', 'Machine-Learning (CVS)');
    })
