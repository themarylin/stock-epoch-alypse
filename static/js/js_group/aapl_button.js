...
function aapl_url() {
    ...
    d3.json("api/rand?stock=AAPL").then(function (rand_response) {
        var jump1 = 50;
    ...
    d3.json("api/scen?stock=AAPL").then(function (response) {
        var jump = 50;
        ...
        renderLineChart(dates, ideal, 'ideal-chart', 'Ideal (AAPL)');
        renderLineChart(dates, ml, 'ml-chart', 'Machine-Learning (AAPL)');
    })
